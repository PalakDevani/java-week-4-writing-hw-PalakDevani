...
public class Programme_3_FindVowelOrConsonant {
    public static void checkVowelOrConsonant(String letter) {
        if (letter.length() > 1) //checks length of String
        {
            System.out.println("Error. Not a single character"); //if user enters more than 1 character an error message is printed

        } else if (!(isItALetter(letter)))     //if user enters a symbol !
        {
